...
- Werk bij elke aanpassing (wijziging aan de code) de constante `VERSION` in `html-album.py` bij met de huidige datum en tijd in het formaat: `2 (DD-MM-YYYY HH:MM)`.
